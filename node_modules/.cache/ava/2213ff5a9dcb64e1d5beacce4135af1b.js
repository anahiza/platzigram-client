...
var _asyncToGenerator2 = require('E:\\Users\\Desarrollo\\Documents\\GitHub\\platzigram-client\\node_modules\\babel-runtime\\helpers\\asyncToGenerator.js');
...
test('getUser', (() => {
  var _ref7 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    t.deepEqual(_rec21._expr(_rec21._capt(user, 'arguments/0'), {
      content: 't.deepEqual(user, result)',
      filepath: 'test\\client-test.js',
      line: 115,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"user","range":[12,16]},{"type":"Identifier","name":"result","range":[18,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"user","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"result","range":[18,24]},{"type":{"label":")"},"range":[24,25]}]',
      visitorKeys: _powerAssertVisitorKeys
...
//# sourceMappingURL=..\node_modules\.cache\ava\2213ff5a9dcb64e1d5beacce4135af1b.js.map